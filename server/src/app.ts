...
import cashPaymentsRoutes from "./routes/cash-payments.routes";
import externalIncomesRoutes from "./routes/external-incomes.routes";
...
app.use("/api/external-incomes", externalIncomesRoutes);
